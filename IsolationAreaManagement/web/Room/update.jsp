...
<div class="col-10 content">
    ...
    <div class="form-container">
        <form action="update" method="POST" id="form-dn" class="form">
            ...
            <input id="roomId" class="form-control" name="roomId" type="text"  style="display: none">
            ...
            <div class="form-group">
                ...
                <input id="areaId" class="form-control" name="areaId" type="text"   style="display: none">
                <input id="areaName" class="form-control" name="areaName" type="text" readonly>
                <span class="form-message"></span>
            </div>
